...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl aspect-square mx-auto flex w-1/3 px-4 sm:px-6 lg:px-8 py-10 bg-[#1d1d1d] rounded-clamp">
      <div className='card_content flex justify-between grow flex-col relative'>
      ...
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 bg-[#2c2c2c] rounded-clamp">
      <div className='card_content flex justify-between grow flex-col relative'>
        <h2 className='text-xl font-bold text-white'>Titre de la carte</h2>
        <div className='card_description mt-auto'>
          <p>Discover digital tools for creatives. A growing collection of Photoshop mockups and Framer components built for modern design workflows.</p>
        </div>
        <div className='card_media absolute'>
